function Video(){
    return(
        <div className="flex flex-col items-center justify-center w-full">
            ...
            <div className="w-full sm:w-[96%] md:w-[94%] lg:w-[88%] xl:w-[82%] aspect-video py-5 pb-15">
                <iframe
                    className="w-full h-full rounded-2xl shadow-[0_0_40px_rgba(235,0,40,0.25)] border border-red-900/30"
