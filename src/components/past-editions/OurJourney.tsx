...
const editions = [
    { id: 1, year: 2025, title: "Kaleidoscopic Interludes", description: `"Kaleidoscopic" evokes vibrant, ever-shifting patterns-glimpses of identity refracted through time and experience. "Interludes" suggests pauses in life's rhythm-transitional moments that carry quiet transformation."`, side: "right", image: "/images/KI.png", island: "/island/island1.svg", islandClass: "-right-64 scale-100 rotate-[15deg]", dotClass: "left-[400px] top-1/2", href: "/kaleidoscopicInterludes" },
