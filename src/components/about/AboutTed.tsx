export default function AboutTed(){
    return (
        <div className="flex flex-col sm:flex-row justify-center items-start gap-1.5 sm:gap-5 md:gap-8 lg:gap-14">
            <div className="w-full sm:w-[52%]">
                <span className="text-[#FF0000] font-cormorant text-[30px] sm:text-[40px] md:text-[60px] lg:text-[81px] font-bold tracking-[0.02em]">TED</span>
                <p className="text-[8px] sm:text-[13px] md:text-[18px] lg:text-[20px] font-normal tracking-[0.01em] font-space">
            ...
            <div className="w-full sm:w-[48%]">
                <span className="text-[#FF0000] font-cormorant text-[30px] sm:text-[40px] md:text-[60px] lg:text-[81px] font-bold tracking-[0.02em]">TEDx</span>
                <p className="text-[8px] sm:text-[13px] md:text-[18px] lg:text-[20px] font-space font-normal tracking-[0.01em]">
