...
export default function BuyTickects() {
    return (
        <div className=" px-4 md:px-10 py-10">
            <h1 className="uppercase text-4xl md:text-6xl text-white text-center mb-8">
                buy tickets
            </h1>

            <div className="bg-black flex flex-col md:flex-row border border-red-500 rounded-2xl w-full max-w-4xl mx-auto min-h-[200px] md:h-[350px]" >

                {/* Left stub - rotated EXP-2026-010 + icon */}
                <div className="flex md:flex-col items-center justify-center gap-3 py-4 md:py-0 md:w-20 shrink-0 border-b md:border-b-0 md:border-r border-dashed border-white/40">
                    <div className="flex items-center gap-10 md:[writing-mode:vertical-rl] md:rotate-180 mb-20 ">
                        <h1 className="uppercase tracking-widest text-2xl whitespace-nowrap text-[#FF0000] font-bebas">
                            EXP-2026-010
                        </h1>
                        <Image
                ...
                <div className="relative flex-1 overflow-hidden border-t md:border-t-0 md:border-l-2 border-dashed border-white/40">
                    {/* Background image fills entire middle section */}
                    <Image
