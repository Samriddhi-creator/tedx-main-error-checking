...
export default function TedxThemeSection() {
  return (
    <div
      ...
      style={{ 
        backgroundImage: "url('/image 58.png')",
    ...
    >
      ...
      {/* 1. Heading Container */}
      <div className="relative pt-12 sm:pt-20 text-left w-full max-w-6xl z-10 flex flex-col leading-[0.9] select-none">
      ...
      <div className="w-full max-w-6xl mt-100 sm:mt-140 mb-8 z-10">
        <div className="flex flex-col p-6 sm:p-8 md:p-12 bg-[#BC1918]/10 border-2 sm:border-3 border-[#EB0028CC] rounded-2xl items-center text-white shadow-2xl ">
          ...
          <h2 className="font-[family-name:var(--font-bebas-neue)] text-3xl sm:text-5xl md:text-6xl lg:text-7xl text-center mb-6 tracking-wider">
            ABOUT THE THEME
          </h2>
